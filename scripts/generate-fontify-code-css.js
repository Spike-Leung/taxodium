...
// `light.txt` and `dark.txt` is generated by `org-html-htmlize-generate-css` from Emacs
...
function generate(light, dark) {
  ...
  return selectors.filter((s) => HighlightSelectorList.includes(s)).map(sel => {
