...
后面考虑写一个 Elisp 的配置，将这个操作封装成 Emacs 的函数，只要选中文字然后调用函数即可。
...
配置 [[https://ohmyz.sh/][Oh My ZSH]] & [[https://spaceship-prompt.sh/][Spaceship]]，一些插件参考: [[https://github.com/antfu/dotfiles/blob/main/.zshrc][antfu/dotfiles]]
