...
#+export_file_name: my-windows-development-environment
#+date:       [2022-10-27 Thu 21:39]
#+filetags:   :published:setup:window:
#+identifier: 20221027T213902
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: Windows 下个人开发环境搭建，涉及 Emacs，WSL，代理，Git，NodeJS 等
#+language: zh-CN
#+author: Spike Leung
...
* 前言
:PROPERTIES:
:CUSTOM_ID: 29edd5d8-87a6-4107-aae1-d5c80a204930
:END:
...
- Emacs
- NodeJS
- [[https://www.google.com/chrome/][Chrome]] or [[https://arc.net/download][Arc]]

* 代理工具
:PROPERTIES:
:CUSTOM_ID: cb1ac055-1308-4f79-804d-e8be4779b148
:END:
...
* Emacs & 环境
:PROPERTIES:
:CUSTOM_ID: 5c477046-87f5-4e8d-9ffa-c85627609973
:END:

最开始的时候，是直接下载 Windows 版本的 Git，NodeJS，Emacs，然后用 git bash 作为终端。

但是 Windows 下使用终端用起来实在不方便，路径和 MacOS，Linux 的不同，不习惯。
...
** WSL
:PROPERTIES:
:CUSTOM_ID: f6d4f67a-7556-4138-85f4-eb94777b8e12
:END:
...
** Windows Terminal
:PROPERTIES:
:CUSTOM_ID: 821d3583-e9c8-48f4-9773-7746edb6bb7f
:END:
...
*** 安装字体
:PROPERTIES:
:CUSTOM_ID: eb6cae51-a390-4f73-87b2-e041a555c86f
:END:
...
*** 配置 Terminal
:PROPERTIES:
:CUSTOM_ID: cae62803-2045-4fad-acc9-c900cbd03c9f
:END:
...
** 按键绑定
:PROPERTIES:
:CUSTOM_ID: 5b4fa079-758f-4ba5-ade6-a4164fc36014
:END:
...
:PROPERTIES:
:CUSTOM_ID: 630669cd-ecd5-4934-a5a9-bd7d34c96a02
:END:

*** Windows -> WSL
:PROPERTIES:
:CUSTOM_ID: 006578d8-fcc2-4353-8f1b-0471dc2637ea
:END:
...
*** WSL -> Windows
:PROPERTIES:
:CUSTOM_ID: 2518a15a-df65-4a60-b5d0-9f53d1607443
:END:
...
** Ubuntu 环境配置
:PROPERTIES:
:CUSTOM_ID: 812c0e03-5e88-4967-9f0a-d5d6b362e30b
:END:

*** Git
:PROPERTIES:
:CUSTOM_ID: 5019f0cc-2dfd-400d-8fb3-9fb410c3068c
:END:
...
*** systemd
:PROPERTIES:
:CUSTOM_ID: 7906ec1b-2f6b-4a46-a519-dbcf281f6340
:END:
...
*** zsh
:PROPERTIES:
:CUSTOM_ID: a272d136-0ac1-4d11-b2a2-4c9d57910553
:END:
...
*** NodeJS
:PROPERTIES:
:CUSTOM_ID: 9527c4eb-b1ea-4fbb-ad3d-c18342a388a7
:END:

下载 [[https://volta.sh/][Volta]] 进行配置：
...
*** Emacs
:PROPERTIES:
:CUSTOM_ID: 602dfb4e-c61c-4e32-a00f-297705dea125
:END:
...
:PROPERTIES:
:CUSTOM_ID: d8ad543f-56e5-4c8f-ae51-e2dd7dccaf34
:END:
...
:PROPERTIES:
:CUSTOM_ID: 4c1f63b9-879b-4dcd-bd2e-dbfd1813be07
:END:
...
* 其他工具
:PROPERTIES:
:CUSTOM_ID: 21af0c8a-4a96-4d9a-8262-83d73b58d643
:END:

- [[https://www.listary.com/][Listary]] :: 主要用于打开应用和打开一些常用网页
- [[https://www.snipaste.com/][Snipaste]] :: 功能齐全的截图工具
- [[https://github.com/microsoft/PowerToys][PowerToys]] :: 键位映射
- [[https://www.screentogif.com/][ScreenToGif]] :: 方便的录屏工具
- [[https://music.163.com/][网易云音乐]] :: 听歌

* 碎碎念
:PROPERTIES:
:CUSTOM_ID: 151990fb-db23-4410-b4d9-1d4317b82e81
:END:
