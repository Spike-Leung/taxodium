...
/* some modified to save snow-toggle state to taxodium.ink */
document.addEventListener('DOMContentLoaded', function() {
  const toggle = document.getElementById('snow-toggle');
  const snowEnable = localStorage.getItem('snowEnable');
  toggle.checked = snowEnable === null ? true : snowEnable === 'true';

  toggle.addEventListener('change', function() {
    localStorage.setItem('snowEnable', this.checked);
  });
});
