#+title:      KPM 算法的 JS 实现
#+export_file_name: kpm-algorithm-for-js
#+date:       [2022-02-22 Tue 21:40]
#+filetags:   :algorithm:js:kpm:published:
#+identifier: 20220222T214009
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: KMP (Knuth–Morris–Pratt algorithm) 算法的说明和 JS 实现
#+language: zh-CN
#+author: Spike Leung
...
* 前缀 & 后缀
:PROPERTIES:
:CUSTOM_ID: ad209d1a-5b2e-4554-879b-d36f8bb91b93
:END:
 #+BEGIN_QUOTE
...
:PROPERTIES:
:CUSTOM_ID: 74d9fee4-67ed-4f78-bb45-649a645c40c5
:END:
  #+BEGIN_QUOTE
...
** PMT 代码实现
:PROPERTIES:
:CUSTOM_ID: 95cbc6b6-87fa-4338-8561-5c6d0c47f4cb
:END:
   #+BEGIN_SRC js
     function getPmt(s) {
       const n = s.length;
       ...
       while (i < n) {
         ...
         if (s[i] == s[j]) {
           ...
           // 当字符出现不匹配的时候，判断 j 前面是否还有公共前缀，有则移动到前缀的下一位
...
* KMP 实现
:PROPERTIES:
:CUSTOM_ID: 35cb4aab-c979-4b57-a038-86b0bfac55fa
:END:
  #+BEGIN_SRC js
    function kmp(s, p) {
      const n = s.length;
...
* leetcode 题目
:PROPERTIES:
:CUSTOM_ID: 84df5d8c-d328-460d-8ffa-485da304f71d
:END:
  - [[https://leetcode-cn.com/problems/implement-strstr/][28. 实现 strStr()]]

* 参考
:PROPERTIES:
:CUSTOM_ID: ec45f179-c570-4f53-9338-f6eba9a54852
:END:
