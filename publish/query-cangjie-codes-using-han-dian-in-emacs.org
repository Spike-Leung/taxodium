...
不過我的用法可能有點怪，現在用䌓體的更多是香港、澳門和臺灣的人，他們的用字有各自的習慣偏好，
...
如果沒有及時關閉這些 ~eww-mode~ 的 buffer，可能會堆積很多临時的 buffer，
可以進入 ~ibuffer~ (@@html:<kbd>C-x C-b</kbd>@@)，
按照 ~eww-mode~ 過濾 buffer (~ibuffer-filter-by-mode~ ，@@html:<kbd>/ RET</kbd>@@)，一次性關閉它們。
