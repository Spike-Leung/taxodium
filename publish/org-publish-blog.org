...
#+attr_html: :role note
#+begin_section
另见：[[denote:20250828T184037][结合 denote 和 org-publish 写博客]]
#+end_section
...
相关代码见 [[https://github.com/Spike-Leung/Spikemacs/blob/main/lisp/init-org-publish.el][init-org-publish.el]]。
...
#+attr_html: :role note
#+begin_section
文章可以在 Emacs China 上讨论：[[https://emacs-china.org/t/org-publish/28006][使用 org-publish 构建博客]]。
#+end_section
