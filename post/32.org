...
#+CAPTION: 一张图表，横轴是天数，分别标记了 18 天、66 天和 254 天，纵轴表示习惯养成的程度。图表的含义是，养成一个习惯不同人需要不同的天数，但是一旦养成，习惯就能保持很久。
...
#+CAPTION: 5 微米以下的木屑薄膜，看起来像是面纱一样，甚至更薄，更透。
...
#+CAPTION: 一个黑色的背景，画了两条紫色的像素风格的线，交叉成一个 X 形状。
