...
[[denote:20250116T213957][当然 Emacs 中的翻译的工具很多]] [fn:1]，写这个函数只是分享一下 =gptel-request= 的一种实现。

逻辑都是 LLM 写的，大体的逻辑是：(源码见 [[https://github.com/Spike-Leung/emacs.d/blob/main/lisp/my-lisp/init-gptel.el][init-gptel]])
...
接下来定一个方法，选择 preset 然后调用 ~gptel--suffix-rewrite~ :
...
* Footnotes
:PROPERTIES:
:CUSTOM_ID: F533A078-6F14-4D96-A6AA-992B7760B5EF
:END:
