...
#+export_file_name: add-form-field-to-pdf
#+INDEX: 往 PDF 上添加 form field
#+date:       [2023-10-23 Mon 21:40]
#+filetags:   :pdf:published:tech:
#+identifier: 20231023T214057
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: 在现有的 PDF 上通过拖拽添加字段后，生成新的 PDF，添加 form field 作为 placeholder 用于填充实际字段内容。
#+language: zh-CN
#+author: Spike Leung
...
* 前言
:PROPERTIES:
:CUSTOM_ID: 7a462ac3-ba42-49e9-b037-dc28935ef136
:END:
...
* 如何将 PDF 渲染出来
:PROPERTIES:
:CUSTOM_ID: 1e6140bc-0d8f-473e-8ada-ae1bb579fcca
:END:
...
* 如何将字段放到 PDF 上对应的位置
:PROPERTIES:
:CUSTOM_ID: ea36e408-ca41-42d0-a472-4b29a1df0843
:END:
...
* 字段如何写入到 PDF 中
:PROPERTIES:
:CUSTOM_ID: 67c1599b-b9ad-4bcf-8d85-f42b0e085c6b
:END:
