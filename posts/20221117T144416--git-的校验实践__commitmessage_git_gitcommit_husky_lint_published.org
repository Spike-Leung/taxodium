#+title:      Git 的校验实践
#+export_file_name: git-lint-practice
#+date:       [2022-11-17 Thu 14:44]
#+filetags:   :commitmessage:git:gitcommit:husky:lint:published:
#+identifier: 20221117T144416
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: 使用 husky，lint-staged 等工具校验 git 提交，从而提高 git 提交的质量。还分享了一些 git message 如何写得更好的内容。
#+language: zh-CN
#+author: Spike Leung
...
* 提交信息 (commit message)
:PROPERTIES:
:CUSTOM_ID: 5b1ecbaf-59bd-4d61-b960-58ced7b49997
:END:

** diff
:PROPERTIES:
:CUSTOM_ID: 8a328885-a800-4c72-95bd-3ce270aa1b67
:END:
...
** 编写方式
:PROPERTIES:
:CUSTOM_ID: 9c8c50af-4d13-4fae-8b84-1f8015c5e3a9
:END:
...
** 格式
:PROPERTIES:
:CUSTOM_ID: 93c301cc-cee5-478d-9e43-f5cf200bb41a
:END:
...
** 工具校验
:PROPERTIES:
:CUSTOM_ID: a916021d-ec14-46e2-a853-71373eea815d
:END:
...
:PROPERTIES:
:CUSTOM_ID: 3ce0d8f2-3967-4dc7-993f-f0255cf2aefd
:END:
...
* githooks / husky
:PROPERTIES:
:CUSTOM_ID: fea552db-1ea9-45f0-9eb8-3d95e69f62d2
:END:
...
** 配置方法
:PROPERTIES:
:CUSTOM_ID: d8973eec-b860-4d67-8dc1-5865837515b7
:END:
*** githooks
:PROPERTIES:
:CUSTOM_ID: 1ed84eb9-084f-41d5-a96e-ffad1a84956b
:END:
- 进入 githooks 所在的目录
  #+begin_src bash
...
*** husky
:PROPERTIES:
:CUSTOM_ID: 0c3c479f-31ee-4596-8779-2b77675f7e32
:END:
...
** 一些例子
:PROPERTIES:
:CUSTOM_ID: 27fcb9b4-e311-4cf3-b13d-7af6919fbe65
:END:
#+begin_src bash
...
*** 校验提交信息 (commit-msg)
:PROPERTIES:
:CUSTOM_ID: 608da1e1-6ffa-4f8e-b618-5f8284647bb6
:END:
...
:PROPERTIES:
:CUSTOM_ID: b568a982-3ed4-4d97-af63-abe11f373d79
:END:
#+begin_src shell
  #!/usr/bin/env sh
  . "$(dirname -- "$0")/_/husky.sh"
...
:PROPERTIES:
:CUSTOM_ID: 35c1589b-671f-4259-854e-377d7680471f
:END:
#+begin_src shell
  #!/bin/sh
  # 获取 main 分支最新的提交
...
* changelog
:PROPERTIES:
:CUSTOM_ID: b52167c5-572b-4192-8af9-4c949d26bbf5
:END:
...
* Refs
:PROPERTIES:
:CUSTOM_ID: c2f7dc25-f0e2-48c7-b022-1b2a304ba14e
:END:
