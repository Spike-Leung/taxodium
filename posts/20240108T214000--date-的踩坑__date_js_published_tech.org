#+title:      Date 的踩坑
#+export_file_name: you-dont-know-date
#+date:       [2024-01-08 Mon 21:40]
#+filetags:   :date:js:published:tech:
#+identifier: 20240108T214000
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: 分享碰到的一个 Date 的问题，分析其原因，主要和 Date 的参数格式有关。
#+language: zh-CN
#+author: Spike Leung
...
:PROPERTIES:
:CUSTOM_ID: d7c89a1a-b1bf-4a36-be8e-1cd14a1a0fd8
:END:
...
** 如何规避
:PROPERTIES:
:CUSTOM_ID: 022d68a4-eca9-42a7-b2c9-b018154960d3
:END:
...
* Refs
:PROPERTIES:
:CUSTOM_ID: e8fc7a0d-306a-47b3-8222-a65b5595d920
:END:
...
- [[https://brandondong.github.io/blog/javascript_dates/][Why are 2025/05/28 and 2025-05-28 different days in JavaScript?]]
