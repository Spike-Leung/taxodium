#+title:      JS 中的定时任务
#+export_file_name: js-timer
#+date:       [2022-02-14 Mon 21:39]
#+filetags:   :js:published:timer:
#+identifier: 20220214T213945
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: 分享一些关于 setTimeout, setInterval, requestAnimationFrame, requestIdleCallback 的使用
#+language: zh-CN
#+author: Spike Leung
...
* setTimeout
:PROPERTIES:
:CUSTOM_ID: f0dca97f-946b-46c2-9339-a5c1d4590523
:END:
[[https://developer.mozilla.org/en-US/docs/Web/API/setTimeout][
setTimeout()]] 可以设置一个延迟，延迟多少秒将一个 callback 放入到[[https://developer.mozilla.org/en-US/docs/Web/API/HTML_DOM_API/Microtask_guide#tasks_vs_microtasks][宏任务队列]]。
...
:PROPERTIES:
:CUSTOM_ID: 40fae145-6e94-416e-a72f-350fd1880515
:END:
...
* setInterval
:PROPERTIES:
:CUSTOM_ID: a8295c06-e05d-4c94-b0e4-8b737c4b7f8a
:END:
...
** 对于长时间的同步任务
:PROPERTIES:
:CUSTOM_ID: 82e839e4-7bda-4599-a7b9-3d9eeceef12b
:END:
#+BEGIN_SRC js
...
** 对于长时间的异步任务
:PROPERTIES:
:CUSTOM_ID: 6de052fe-4204-4e10-8196-fcbfbdb40a37
:END:
#+BEGIN_SRC js
  let counter = 0;
  var fakeTimeIntensiveOperation = function() {
...
* 嵌套的 setTimeout
:PROPERTIES:
:CUSTOM_ID: 46d047df-e0c6-47dd-821d-ca4b193e2771
:END:
#+BEGIN_SRC js
  (function loop() {
    setTimeout(function() {
...
:PROPERTIES:
:CUSTOM_ID: 5aab62ca-ad70-4b78-84f4-86e74d49487a
:END:
...
* requestIdleCallback
:PROPERTIES:
:CUSTOM_ID: 2c323e30-2444-4f60-a69a-4a59c57a7430
:END:
...
* 参考
:PROPERTIES:
:CUSTOM_ID: 61b9c400-75a3-4bb0-8097-8bf7112cf28e
:END:
