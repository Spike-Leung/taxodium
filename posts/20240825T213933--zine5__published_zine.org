...
#+CAPTION: 一张图表，横轴是花费的时间，纵轴是团队规模大小。图表中，按照不同的沟通类型，如面对面沟通、文档、视频等，基于他们花费的时间和适合的团队，放在不同位置。其中，对于任意规模的团队而言，文档和视频是最合适的。 (图片来源：er4hn.info)
...
[[file:./images/zine/5/松-Carsick Cars.jpg]]
