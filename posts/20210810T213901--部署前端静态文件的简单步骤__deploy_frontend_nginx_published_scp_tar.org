#+title:      部署前端静态文件的简单步骤
#+export_file_name: deploy-static-file-to-server
#+date:       [2021-08-10 Tue 21:39]
#+filetags:   :deploy:frontend:nginx:published:scp:tar:
#+identifier: 20210810T213901
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: 部署前端打包输出的静态文件到 nginx，结合 scp、tar 以及 bash 脚本实现相对方便的发布。
#+language: zh-CN
#+author: Spike Leung
...
* 打包构建
:PROPERTIES:
:CUSTOM_ID: cc74359f-6031-479a-bec6-e27e93f9d739
:END:
...
* tar 打包
:PROPERTIES:
:CUSTOM_ID: 4c93ce12-f0c7-4c6a-bb81-bfcd8f77c8e6
:END:
...
** 压缩
:PROPERTIES:
:CUSTOM_ID: 8467a708-e5fe-4f7b-9cc6-9a51df55b7e7
:END:
...
* scp 上传 tar 包
:PROPERTIES:
:CUSTOM_ID: df4236b1-6886-4a6b-8a90-fac73e453b56
:END:
...
* ssh 到目标机器
:PROPERTIES:
:CUSTOM_ID: 2ed42da8-c367-469d-8e46-bb1b623f1f39
:END:
...
** 避免重复输入密码
:PROPERTIES:
:CUSTOM_ID: 94458263-c020-4648-8172-8f64073c27c6
:END:
...
** 移除过期的指纹
:PROPERTIES:
:CUSTOM_ID: cdfb8a5f-7732-4465-891b-a8f517d1353e
:END:
...
* 解压 tar 包
:PROPERTIES:
:CUSTOM_ID: a44304ac-5b89-401c-b64a-042474311c56
:END:
...
* 节省手动操作
:PROPERTIES:
:CUSTOM_ID: 574e60c7-21fb-4f52-ae0d-bb846d804392
:END:
...
* 进一步节省操作
:PROPERTIES:
:CUSTOM_ID: 7ff082cd-209a-4542-a231-7009867d5b56
:END:
...
* 参考链接
:PROPERTIES:
:CUSTOM_ID: 1211fb78-de36-4bb7-afea-7cb004df2007
:END:
