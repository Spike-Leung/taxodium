...
#+begin_src emacs-lisp
  ...
  (advice-add 'org-publish :before #'spike-leung/setup-org-publish-project-alist) ;; 在执行 org-publish 之前更新 org-publish-project-alist
#+end_src
#+end_details
...
4. 由于文件名上有很多 keyword，我可以通过 keyword 区分哪些是 zine，哪些是关于 emacs 的，可以基于此生成它们各自的 RSS[fn:3]
...
* Footnotes
:PROPERTIES:
:CUSTOM_ID: 94F494D4-0663-4A65-A2F6-F9F9A74C704C
:END:
...
[fn:3] 我目前生成了 Zine 和 Emacs 的订阅流，你可以在 [[https://taxodium.ink/rss.xml][订阅]] 中找到 :)
