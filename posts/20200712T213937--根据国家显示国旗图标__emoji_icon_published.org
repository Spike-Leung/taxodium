#+title:      根据国家显示国旗图标
#+export_file_name: make-country-flag-icon
#+date:       [2020-07-12 Sun 21:39]
#+filetags:   :emoji:icon:published:
#+identifier: 20200712T213937
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: 分享使用 emoji 和图片，显示国旗的方法
#+language: zh-CN
#+author: Spike Leung
