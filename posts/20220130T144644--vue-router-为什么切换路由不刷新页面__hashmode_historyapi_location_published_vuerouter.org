...
#+export_file_name: history-api-vs-hash
#+date:       [2022-01-30 Sun 14:46]
#+filetags:   :hashmode:historyapi:location:published:vuerouter:
#+identifier: 20220130T144644
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: 探索 Vue Router 切换路由为什么页面不会触发 reload。主要涉及 History API 以及 URL hash。
#+language: zh-CN
#+author: Spike Leung
