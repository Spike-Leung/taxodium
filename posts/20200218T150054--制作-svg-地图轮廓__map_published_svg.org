#+title:      制作 SVG 地图轮廓
#+export_file_name: make-svg-map-outline
#+date:       [2020-02-18 Tue 15:00]
#+filetags:   :map:published:svg:
#+identifier: 20200218T150054
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: 用 mapshaper 制作地图轮廓的 SVG
#+language: zh-CN
#+author: Spike Leung
...
* 前言
:PROPERTIES:
:CUSTOM_ID: 9cef0750-a7a1-4eb6-a75f-a9b1a854e051
:END:
...
* 获取 GIS 数据
:PROPERTIES:
:CUSTOM_ID: b20d5729-db28-4cba-8c95-158f0a6bfdae
:END:
...
* 截取需要的地图轮廓
:PROPERTIES:
:CUSTOM_ID: 104010d2-b581-48de-82b3-aadf298275ca
:END:
...
* 简化地图
:PROPERTIES:
:CUSTOM_ID: 339bf6b4-1cfa-4191-93b8-cc4dccf57d09
:END:
...
* 导出时增加信息
:PROPERTIES:
:CUSTOM_ID: 39ef259f-ea51-447d-9f07-30d9b0b5186b
:END:
...
* 参考链接
:PROPERTIES:
:CUSTOM_ID: f4310c42-3cdc-481f-99ad-581f2dc99184
:END:
