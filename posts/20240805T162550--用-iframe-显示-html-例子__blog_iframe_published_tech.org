...
在 [[file:1.org][zine#1]] 中分享了一篇关于 CSS 布局的小册子: [[https://book.mixu.net/css/][Learn CSS Layout]]，作者写得很好，虽然引用了很多规范，但是看起来不枯燥，反倒挺有趣，有一种醍醐灌顶的感觉。
...
于是我也依葫芦画瓢，在 [[file:word-break.org][work-break: break-all;]] 这篇文章使用了。
