...
#+export_file_name: use-iframe-for-blog-demo
#+date:       [2024-08-05 Mon 16:25]
#+filetags:   :blog:iframe:published:tech:
#+identifier: 20240805T162550
#+bind:       denote-directory "~/git/taxodium/posts"
#+description: 博客中使用 iframe 去呈现一些 HTML 例子
#+language: zh-CN
#+author: Spike Leung
...
在 [[denote:20240728T191027][Zine#1]] 中分享了一篇关于 CSS 布局的小册子: [[https://book.mixu.net/css/][Learn CSS Layout]]，作者写得很好，虽然引用了很多规范，但是看起来不枯燥，反倒挺有趣，有一种醍醐灌顶的感觉。
...
于是我也依葫芦画瓢，在 [[denote:20240804T163226][word-break: break-all;]] 这篇文章使用了。
